...
class __TwigTemplate_5f4bed8531ae7ea8f6f5eb4820b2e67aacec56f0f6c4a9cd72ea0eff06d1708e extends Twig_Template
{
...
/* <div class="g-tabs" role="tablist">*/
/*     <ul>*/
/*         <li class="active"><a href="#" id="g-switcher-platforms-tab" role="presentation" aria-controls="g-switcher-platforms" role="tab" aria-expanded="true">{{ 'GANTRY5_PLATFORM_PRESETS'|trans }}</a></li>*/
/*         <li><a href="#" id="g-switcher-platforms-outlines" role="presentation" aria-controls="g-switcher-outlines" role="tab" aria-expanded="false">{{ 'GANTRY5_PLATFORM_OUTLINES'|trans }}</a></li>*/
/*     </ul>*/
/* </div>*/
/* */
/* <div class="g-panes">*/
...
/*             <li tabindex="0" class="g-switch-title" role="presentation">{{ name == 'user' ? 'User' : 'Platform' }}</li>*/
/*             {% for key, current in group %}*/
/*             <li tabindex="0" aria-label="{{ current|e }} Preset" role="button" data-switch="{{ gantry.route('configurations/' ~ configuration ~ '/layout/preset/' ~ key) }}" class="g-switch-preset">{{ current|e }}</li>*/
/*             {% endfor %}*/
/*         </ul>*/
/*         {% endfor %}*/
/*     </div>*/
...
/*                 <li tabindex="0" aria-label="{{ label }} Outline" role="button" data-switch="{{ gantry.route('configurations/' ~ configuration ~ '/layout/switch/' ~ key) }}" class="g-switch-configuration">{{ label }}</li>*/
/*             {% endfor %}*/
/*         </ul>*/
/* */
